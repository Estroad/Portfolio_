 ...
 * @author ghdud
 */
public class charupdate extends javax.swing.JFrame {
    String id;
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/bicons/cha/수정.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/insert/char/차트내용.png"))); // NOI18N
  ...
  Statement stmt = null;
        try {
            ...
            Logger.getLogger(charupdate.class.getName()).log(Level.SEVERE, null, ex);
        }
  ...
  String contents = jTextField1.getText();  
         ...
         String sql = "UPDATE charts SET chart_contents='"+contents+"'";
          try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(charupdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new charupdate().setVisible(true);
            }
        });
    }
