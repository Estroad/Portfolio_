 ...
 * @author ghdud
 */
public class nurupdate extends javax.swing.JFrame {
    String id;
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/bicons/nur/수정.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/insert/nur/간호사직위.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/insert/nur/진료과목.png"))); // NOI18N
  ...
  Statement stmt = null;
        try {
            ...
            Logger.getLogger(nurupdate.class.getName()).log(Level.SEVERE, null, ex);
        }
  ...
  String posi = jTextField4.getText();
         ...
         String sql = "UPDATE Nurses SET major_job = '"+major+"', nur_phone = '" +phone+"' ,nur_email = '" + email+ "', nur_position = '" +posi+"' where nur_id = "+id;
          try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nurupdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
